...
F_taller_182 = 1 - 0.8413
F_taller_182_python = 1 - stats.norm.cdf(182, loc=M, scale=8)
print(F_taller_182, F_taller_182_python)
# 2. больше 190 см?
z = (190 - M) / sd  # z = 2, по таблице находим долю для этого значения 0.9772
F_taller_190 = 1 - 0.9772
F_taller_190_python = 1 - stats.norm.cdf(190, loc=M, scale=8)
print(F_taller_190, F_taller_190_python)
# 3. от 166 см до 190 см?
z = (166 - M) / sd  # z = -1, по таблице находим долю для этого значения 0.1587
F_from_166_to_190 = 0.9772 - 0.1587
F_from_166_to_190_python = stats.norm.cdf(190, loc=M, scale=8) - stats.norm.cdf(166, loc=M, scale=8)
print(F_from_166_to_190, F_from_166_to_190_python)
# 4. от 166 см до 182 см?
F_from_166_to_182 = 0.8413 - 0.1587
F_from_166_to_182_python = stats.norm.cdf(182, loc=M, scale=8) - stats.norm.cdf(166, loc=M, scale=8)
print(F_from_166_to_182, F_from_166_to_182_python)
# 5. от 158 см до 190 см?
z = (158 - M) / sd  # z = -2, по таблице находим долю для этого значения 0.0228
F_from_158_to_190 = 0.9772 - 0.0228
F_from_158_to_190_python = stats.norm.cdf(190, loc=M, scale=8) - stats.norm.cdf(158, loc=M, scale=8)
print(F_from_158_to_190, F_from_158_to_190_python)
# 6. не выше 150 см или не ниже 190 см?
z = (150 - M) / sd  # z = -3, по таблице находим долю для этого значения 0.0013
F_to_150_and_taller_190 = 0.0013 + F_taller_190
F_to_150_and_taller_190_python = stats.norm.cdf(150, loc=M, scale=8) + F_taller_190_python
...
F_to_150_and_taller_198 = 0.0013 + (1 - 0.9987)
F_to_150_and_taller_198_python = stats.norm.cdf(150, loc=M, scale=8) + (1 - stats.norm.cdf(198, loc=M, scale=8))
print(F_to_150_and_taller_198, F_to_150_and_taller_198_python)
# 8. ниже 166 см?
z = (166 - M) / sd  # z = -1, по таблице находим долю для этого значения 0.1587
F_to_166 = 0.1587
F_to_166_python = stats.norm.cdf(166, loc=M, scale=8)
